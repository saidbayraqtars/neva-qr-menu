...
<div class="mag">
    <header class="mag-head <?php echo e($coverUrl ? '' : 'no-cover'); ?>" data-tpl-cover data-has-cover="<?php echo e($coverUrl ? '1' : ''); ?>"
            <?php if($coverUrl): ?> style="background-image:url('<?php echo e($coverUrl); ?>')" <?php endif; ?>>
        <div class="mag-head-inner">
            <span class="mag-kicker">MENÜ · <?php echo e(now()->year); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.logo','data' => ['url' => $logoUrl,'name' => $restaurant->name,'class' => 'mag-logo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($logoUrl),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($restaurant->name),'class' => 'mag-logo']); ?>
...
<?php endif; ?>
            <h1 class="mag-title tpl-h"><?php echo e($restaurant->name); ?></h1>
            <?php if($restaurant->tagline): ?><p class="mag-tag"><?php echo e($restaurant->tagline); ?></p><?php endif; ?>
        </div>
    </header>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <section class="mag-cat">
            <h2 class="mag-cat-name tpl-h"><?php echo e($category->name); ?></h2>
            <div class="mag-masonry">
                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $img = $p->productImage($product); ?>
                    <article class="mag-card <?php echo e($loop->first ? 'is-lead' : ''); ?>" <?php echo flag_attrs($product); ?>>
                        <?php if($img): ?><img class="mag-img" src="<?php echo e($img); ?>" alt="<?php echo e($product->name); ?>" loading="lazy"><?php endif; ?>
                        <div class="mag-body">
...
<?php endif; ?>
                            <h3 class="mag-name tpl-h"><?php echo e($product->name); ?></h3>
                            <?php if($showDesc && $product->description): ?><p class="mag-desc"><?php echo e($product->description); ?></p><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.price','data' => ['product' => $product,'currency' => $currency,'show' => $showPrices,'class' => 'mag-price']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currency),'show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showPrices),'class' => 'mag-price']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\saidb\Desktop\projeler\nevaqrmenü\resources\views/templates/skeletons/magazine-grid.blade.php ENDPATH**/ ?>