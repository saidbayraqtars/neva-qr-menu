...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.logo','data' => ['url' => $logoUrl,'name' => $restaurant->name,'class' => 'at-logo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($logoUrl),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($restaurant->name),'class' => 'at-logo']); ?>
...
<?php endif; ?>
        <h1 class="at-title tpl-h"><?php echo e($restaurant->name); ?></h1>
        <?php if($restaurant->tagline): ?><p class="at-tag"><?php echo e($restaurant->tagline); ?></p><?php endif; ?>
    </header>

    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <section class="at-cat">
            <h2 class="at-cat-name tpl-h"><?php echo e($category->name); ?></h2>
            <?php if($category->description): ?><p class="at-cat-desc"><?php echo e($category->description); ?></p><?php endif; ?>
            <div class="at-stack">
                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $img = $p->productImage($product); ?>
                    <article class="at-card <?php echo e($img ? 'has-media' : ''); ?>" <?php echo flag_attrs($product); ?>>
                        <?php if($img): ?><div class="at-media"><img src="<?php echo e($img); ?>" alt="<?php echo e($product->name); ?>" loading="lazy"></div><?php endif; ?>
                        <div class="at-body">
...
<?php endif; ?>
                            <div class="at-line">
                                <h3 class="at-name tpl-h"><?php echo e($product->name); ?></h3>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.price','data' => ['product' => $product,'currency' => $currency,'show' => $showPrices,'class' => 'at-price']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currency),'show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showPrices),'class' => 'at-price']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if($showDesc && $product->description): ?><p class="at-desc"><?php echo e($product->description); ?></p><?php endif; ?>
...
<?php /**PATH C:\Users\saidb\Desktop\projeler\nevaqrmenü\resources\views/templates/skeletons/atelier-soft.blade.php ENDPATH**/ ?>