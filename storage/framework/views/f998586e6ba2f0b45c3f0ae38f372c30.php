...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.logo','data' => ['url' => $logoUrl,'name' => $restaurant->name,'class' => 'sf-logo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($logoUrl),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($restaurant->name),'class' => 'sf-logo']); ?>
...
<?php endif; ?>
        <h1 class="sf-title tpl-h"><?php echo e($restaurant->name); ?></h1>
        <?php if($restaurant->tagline): ?><p class="sf-tag"><?php echo e($restaurant->tagline); ?></p><?php endif; ?>
        <div class="sf-orn" aria-hidden="true">✦</div>
    </header>

    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <section class="sf-cat">
            <h2 class="sf-cat-name tpl-h"><span><?php echo e($category->name); ?></span></h2>
            <?php if($category->description): ?><p class="sf-cat-desc"><?php echo e($category->description); ?></p><?php endif; ?>
            <div class="sf-list">
                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $img = $p->productImage($product); ?>
                    <article class="sf-card" <?php echo flag_attrs($product); ?>>
                        <?php if($img): ?>
                            <div class="sf-thumb"><img src="<?php echo e($img); ?>" alt="<?php echo e($product->name); ?>" loading="lazy"></div>
                        <?php endif; ?>
                        <div class="sf-body">
...
<?php endif; ?>
                            <h3 class="sf-name tpl-h"><?php echo e($product->name); ?></h3>
                            <?php if($showDesc && $product->description): ?><p class="sf-desc"><?php echo e($product->description); ?></p><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.price','data' => ['product' => $product,'currency' => $currency,'show' => $showPrices,'class' => 'sf-price']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currency),'show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showPrices),'class' => 'sf-price']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\saidb\Desktop\projeler\nevaqrmenü\resources\views/templates/skeletons/saffron-table.blade.php ENDPATH**/ ?>