...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
         ...
         class="absolute z-50 mt-2 <?php echo e($width); ?> rounded-2xl <?php echo e($alignmentClasses); ?>"
         style="display: none;"
         @click="open = false">
        <div class="rounded-2xl bg-white py-1.5 shadow-luxe ring-1 ring-ink-100">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\Users\saidb\Desktop\projeler\nevaqrmenü\resources\views/components/dropdown.blade.php ENDPATH**/ ?>