...
<div class="mg">
    <?php if($coverUrl): ?>
        <div class="mg-cover" data-tpl-cover data-has-cover="1" style="background-image: url('<?php echo e($coverUrl); ?>')"></div>
    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.logo','data' => ['url' => $logoUrl,'name' => $restaurant->name,'class' => 'mg-logo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($logoUrl),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($restaurant->name),'class' => 'mg-logo']); ?>
...
<?php endif; ?>
        <div class="mg-head-txt">
            <h1 class="mg-title tpl-h"><?php echo e($restaurant->name); ?></h1>
            <?php if($restaurant->tagline): ?><p class="mg-tag"><?php echo e($restaurant->tagline); ?></p><?php endif; ?>
        </div>
    </header>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <section class="mg-cat">
            <h2 class="mg-cat-name tpl-h"><?php echo e($category->name); ?></h2>
            <div class="mg-grid">
                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $img = $p->productImage($product); ?>
                    <article class="mg-card" <?php echo flag_attrs($product); ?>>
                        <div class="mg-photo" <?php if($img): ?> style="background-image:url('<?php echo e($img); ?>')" <?php endif; ?>>
                            <?php if (! ($img)): ?><span class="mg-initial"><?php echo e(\Illuminate\Support\Str::of($product->name)->substr(0, 1)->upper()); ?></span><?php endif; ?>
                        </div>
...
<?php endif; ?>
                        <div class="mg-cap">
                            <span class="mg-name"><?php echo e($product->name); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tpl.price','data' => ['product' => $product,'currency' => $currency,'show' => $showPrices,'class' => 'mg-price']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currency),'show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showPrices),'class' => 'mg-price']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php if($showDesc && $product->description): ?><p class="mg-desc"><?php echo e($product->description); ?></p><?php endif; ?>
                    </article>
...
<?php /**PATH C:\Users\saidb\Desktop\projeler\nevaqrmenü\resources\views/templates/skeletons/modern-grid.blade.php ENDPATH**/ ?>